...
@Component({
  ...
  selector: 'app-nlfempstatusreport',
  templateUrl: './nlfempstatusreport.component.html',
  styleUrls: ['./nlfempstatusreport.component.css']
})
export class NlfempstatusreportComponent implements OnInit {
  StatusList: any;
  StatusType:any = "";
  FollowerName:any = "";
