...
export class ExtCustomerService {
  ...
  private CustTrackUrl=Api.SaveCustomerTrackUrl;
  SaveCustomerTrack(CustomerTrack:any){
    return this.objApi.callPost(this.CustTrackUrl,CustomerTrack);
  }
